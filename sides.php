...
$select_product=select_product("sides");
    ...
    <app-basket-right _ngcontent-pre-c6="" _nghost-pre-c8="">
        <div _ngcontent-pre-c8="" class="bg-white py-2 list-group-flush cart-div-area  px-2">
                                ...
                                <div _ngcontent-pre-c8="" class="card mb-0 bg-white border-0 d-block w-100 col-12 w-100 d-block px-0 px-auto ">
                                    ...
                                    if(isset($_SESSION["baskit_cart"])){
                                     foreach ($_SESSION["baskit_cart"] as $product){
                                      ...
                                      ?>
                                    <form action="sides.php" method="post">
            ...
            <div _ngcontent-pre-c8="" class="d-block mt-4">
                    ...
                    <div _ngcontent-stv-c18="" class="row">
                        <div _ngcontent-stv-c18="" class="col-12 col-sm-12 px-0 mx-0 px-md-3 px-md-0">
                        <div _ngcontent-stv-c18="" class="row py-3 px-0 mb-5 mb-md-3 mt-n2">
                            <?php while($row= mysqli_fetch_assoc($select_product)){
                                $id=$row['id']; 
                                ?>
<div _ngcontent-stv-c18="" class="col-6 col-sm-4 col-md-4 col-lg-3 px-1 product-card-wrapper">
    <div _ngcontent-stv-c18="" class="card mt-2 product-card">
        <form action="sides.php" method="post">
        <div _ngcontent-stv-c18="" clas="crdTop">
            <img _ngcontent-stv-c18="" class="card-img-top bg-dark" min-height="100px" width="100%" src="<?='data:image/jpeg;base64,'.base64_encode( $row['image'] );?>" alt="Garlic Bread"></div>
        <div _ngcontent-stv-c18="" class="card-body px-2">
            <div _ngcontent-stv-c18="" class="title h5 mb-1 text-capitalize product-name"><?=$row['name'];?></div>
            <div _ngcontent-stv-c18="" class="col-dblock product-descripton">
                <p _ngcontent-stv-c18="" class="card-text col-12 px-1"><?=$row['product_description'];?></p></div><div _ngcontent-stv-c18="" class="d-block pt-4 pt-md-2 pb-1 "> Select Size &amp; Type </div>
